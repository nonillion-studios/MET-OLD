...
export default function App() {
  ...
  // Defaults to open on desktop (where this aside renders as a static column via
  // md:static) but closed on phone/tablet widths, where it's a fixed-position overlay
  // that covers most of the screen (w-64 max-w-[85vw]) - defaulting it open there means
  // the very first thing a phone user sees on entering the studio is the canvas almost
  // entirely blocked by the thumbnails panel, before they've done anything.
